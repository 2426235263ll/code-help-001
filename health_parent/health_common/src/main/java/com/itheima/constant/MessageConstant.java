...
public class MessageConstant {
    ...
    public static final String QUERY_ADDRESS_FAIL = "查询地图信息失败";
    public static final String QUERY_ADDRESS_SUCCESS = "查询地图信息成功";
    public static final String ADD_ADDRESS_SUCCESS = "添加地图信息成功";
    public static final String ADD_ADDRESS_FAIL = "添加地图信息失败";
    public static final String ADD_ADDRESS_ALREADY_EXIST = "添加失败,地址已存在";
    public static final String DELETE_ADDRESS_SUCCESS = "删除地图信息成功";
    ...
    public static final String QUERY_ROLE_SUCCESS = "查询角色数据成功";
    public static final String QUERY_ROLE_FAIL = "查询角色数据失败";
    ...
    public static final String DELETE_ORDERLIST_SUCCESS ="删除预约信息成功";
    public static final String DELETE_ORDERLIST_FAIL ="删除预约信息失败";
    ...
    public static final String ORDER_FAIL = "处理失败,请重试";
